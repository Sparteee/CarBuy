 ...
 */
final class Version20220301160852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D1E969C5 FOREIGN KEY (utilisateurs_id) REFERENCES utilisateur (id)');
